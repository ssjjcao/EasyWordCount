    ...
    public static void main(String[] args) throws Exception {
        ...
        while ((str = bufferedReader.readLine()) != null) {
            ...
            if (splitResult.length >= 2) {
                ...
                if (thisWord.toString().length() >= 2 && count >= 500) {
                    if (count > 5000) {
                        count = 5000 + (int) Math.sqrt(count - 5000);
                    }
...
//        wordCloud.setColorPalette(new ColorPalette(Color.RED, Color.MAGENTA, Color.GREEN, Color.ORANGE, Color.BLUE, Color.CYAN));
        wordCloud.setColorPalette(new ColorPalette(Color.RED, Color.GREEN, Color.ORANGE, Color.BLUE));
